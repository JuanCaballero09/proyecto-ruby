class ContactosController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to contactos_path, status: :see_other, notice: "Contacto was successfully destroyed." }
  ...
  private
    ...
    def contacto_params
      params.expect(contacto: [ :nombre, :correo, :telefono, :direccion ])
    end
end

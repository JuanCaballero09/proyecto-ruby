...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference("Contacto.count") do
      post contactos_url, params: { contacto: { correo: @contacto.correo, direccion: @contacto.direccion, nombre: @contacto.nombre, telefono: @contacto.telefono } }
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { correo: @contacto.correo, direccion: @contacto.direccion, nombre: @contacto.nombre, telefono: @contacto.telefono } }

...
class ComidaBloc extends Bloc<ComidaEvent, ComidaState> {
  ComidaBloc() : super(ComidasInicial()) {
    on<CargarComidas>((event, emit) {
      final comidas = [
        Comida(nombre: 'Hamburguesa criolla', descripcion: 'Con huevo y arepa', precio: 12000),
        Comida(nombre: 'Perro caliente', descripcion: 'Con papas, queso y piña', precio: 7000),
        Comida(nombre: 'Salchipapa', descripcion: 'Papas fritas con salchichas', precio: 12000),
        Comida(nombre: 'Mazorcada', descripcion: 'Con queso, pollo, tocineta y salsa', precio: 15000),
      ];
